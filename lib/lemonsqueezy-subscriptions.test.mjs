...
test("unpaid is terminal while past_due remains recoverable", () => {
  assert.equal(isTerminalUnpaidStatus("unpaid"), true);
  assert.equal(isTerminalUnpaidStatus("past_due"), false);
});
